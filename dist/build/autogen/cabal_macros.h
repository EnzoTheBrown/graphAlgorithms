...
/* package graphAlgorithms-0.1.0.0 */
#define VERSION_graphAlgorithms "0.1.0.0"
#define MIN_VERSION_graphAlgorithms(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package graphviz-2999.19.0.0 */
#define VERSION_graphviz "2999.19.0.0"
...
#define CURRENT_COMPONENT_ID "graphAlgorithms-0.1.0.0"

#define CURRENT_PACKAGE_KEY "graphAlgorithms-0.1.0.0"
